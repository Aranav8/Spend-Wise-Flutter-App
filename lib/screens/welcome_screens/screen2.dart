...
import 'package:spend_wise/screens/welcome_screens/screen1.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Set and Maintain Achievable Budgets',
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          "Set spending limits by category with SpendWise to allocate your money wisely, ensuring priorities are funded.",
                          textAlign: TextAlign.center,
                          style: kWelcomeText,
                        ),
                      ),
